...
PICS = (environ.get('PICS', 'https://envs.sh/Y8L.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/Y8L.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/Wdj.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/Wdj.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/Yor.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/Wdj.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5906206984 7965267063').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002523558100').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002599639831'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002159322288'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002599639831'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '1002250340602'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002599639831')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002343997444')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002159322288')  # Request channel id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/Yor.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'son491413-2okhdfcbank')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://nithish7uy:EU4G8ws46ZQr17tF@cluster0.glvel.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'aedb193fbece0c8370b8535e5ba8a878b4804548')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Tamil_LinksZzz/36')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ji')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/x')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Vedisz')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Warmovietamilss')
OWNERID = int(os.environ.get('OWNERID', '7795004397'))  # Replace with the actual admin ID
...
MSG_ALRT = environ.get('MSG_ALRT', 'Hell my dear Kakashi 🖤')
